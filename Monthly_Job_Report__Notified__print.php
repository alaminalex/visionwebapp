...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Monthly_Job_Report__Notified_.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Monthly_Job_Report__Notified_.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("notified_day_fieldheader", true);
...
if($mastertable == "user")
{
	...
	$dparams = array("detailtable" => "Monthly Job Report (Notified)", "keys" => $masterkeys);
