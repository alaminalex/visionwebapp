...
$page_layouts["Internal_Rejection_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Internal_Rejection.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Internal_Rejection.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("start_date_only_fieldheader", true);
$xt->assign("designer_name_fieldheader", true);
$xt->assign("group_id_fieldheader", true);
$xt->assign("total_estimated_time_fieldheader", true);
$xt->assign("total_designer_time_fieldheader", true);
$xt->assign("efficiency_fieldheader", true);
$xt->assign("rejected_files_fieldheader", true);
