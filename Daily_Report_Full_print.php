...
$page_layouts["Daily_Report_Full_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_Report_Full.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_Report_Full.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("end2_date_shift_fieldheader", true);
$xt->assign("designer2_id_fieldheader", true);
$xt->assign("team_fieldheader", true);
$xt->assign("pdf_estimated_average_fieldheader", true);
$xt->assign("taken_time_fieldheader", true);
