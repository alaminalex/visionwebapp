...
$page_layouts["Daily_Report_Designers_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_Report_Designers.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_Report_Designers.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("eta_total_fieldheader", true);
$xt->assign("Total_time_fieldheader", true);
$xt->assign("eta_Avg_fieldheader", true);
$xt->assign("Taken_Avg_fieldheader", true);
$xt->assign("efficiency_fieldheader", true);
$xt->assign("idle_time_fieldheader", true);
$xt->assign("idle_p_fieldheader", true);
$xt->assign("done_date_fieldheader", true);
$xt->assign("done_Week_fieldheader", true);
$xt->assign("performence_fieldheader", true);
