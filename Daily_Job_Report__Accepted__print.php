...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_Job_Report__Accepted_.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_Job_Report__Accepted_.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
if($mastertable == "notifyoption")
{
	...
	$dparams = array("detailtable" => "Daily Job Report (Accepted)", "keys" => $masterkeys);
