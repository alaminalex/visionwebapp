...
require_once("include/Display_Files_Notifyed_Today_variables.php");
...
$page_layouts["Display_Files_Notifyed_Today_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Display_Files_Notifyed_Today.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Display_Files_Notifyed_Today.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
