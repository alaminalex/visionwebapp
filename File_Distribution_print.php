...
$page_layouts["File_Distribution_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["jobfile_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "File Distribution" );
