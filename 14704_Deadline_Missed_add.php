...
$layout = new TLayout("add_under_2col_center", "Coral1vApplication", "MobilevApplication");
$layout->version = 2;
...
$layout->containers["fields"][] = array("name"=>"addfields2_atop", 
	"block"=>"", "substyle"=>1  );
...
$page_layouts["14704_Deadline_Missed_add"] = $layout;
...
$page_layouts["14704_Deadline_Missed_add_Additional_Complexity1"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["14704_Deadline_Missed_add_Information1"] = $layout;
