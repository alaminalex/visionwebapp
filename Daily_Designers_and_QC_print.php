...
require_once("include/Daily_Designers_and_QC_variables.php");
...
$page_layouts["Daily_Designers_and_QC_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_Designers_and_QC.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_Designers_and_QC.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("done_date_fieldheader", true);
$xt->assign("done_Week_fieldheader", true);
...
$xt->assign("designer_eta_total_fieldheader", true);
$xt->assign("designer_Total_time_fieldheader", true);
$xt->assign("designer_eta_Avg_fieldheader", true);
$xt->assign("designer_Taken_Avg_fieldheader", true);
$xt->assign("designer_efficiency_fieldheader", true);
$xt->assign("designer_performence_fieldheader", true);
$xt->assign("qc_Total_time_fieldheader", true);
$xt->assign("qc_Taken_Avg_fieldheader", true);
