...
$page_layouts["Daily_PDF_Work_Summery_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_PDF_Work_Summery.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_PDF_Work_Summery.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("designer_taken_fieldheader", true);
$xt->assign("designe_performance_fieldheader", true);
$xt->assign("qc_done_fieldheader", true);
$xt->assign("qc_pdf_eta_fieldheader", true);
$xt->assign("qc_taken_fieldheader", true);
$xt->assign("qc_performance_fieldheader", true);
$xt->assign("pdf__total_time_fieldheader", true);
$xt->assign("total_performance_fieldheader", true);
