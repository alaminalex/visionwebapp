...
require_once("include/Team_Report_variables.php");
...
$page_layouts["Team_Report_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Team_Report.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Team_Report.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("user_status_fieldheader", true);
$xt->assign("username_fieldheader", true);
$xt->assign("department_id_fieldheader", true);
$xt->assign("subdiv_id_fieldheader", true);
$xt->assign("group_id_fieldheader", true);
$xt->assign("employee_id_fieldheader", true);
$xt->assign("fname_fieldheader", true);
$xt->assign("lname_fieldheader", true);
$xt->assign("nickname_fieldheader", true);
$xt->assign("email_fieldheader", true);
$xt->assign("phone_fieldheader", true);
$xt->assign("mobile_fieldheader", true);
$xt->assign("images_assigned_fieldheader", true);
$xt->assign("user_picture_fieldheader", true);
$xt->assign("team_fieldheader", true);
$xt->assign("ad_group_id_fieldheader", true);
...
{
	require_once("include/group_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$dparams = array("detailtable" => "Team Report", "keys" => $masterkeys);
	
	$xt->assign_function("showmasterfile", "DisplayMasterTableInfoForPrint_group", $dparams);
...
$page_layouts["group_masterprint"] = $layout;
...
{
	require_once("include/subdivision_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$dparams = array("detailtable" => "Team Report", "keys" => $masterkeys);
	
	$xt->assign_function("showmasterfile", "DisplayMasterTableInfoForPrint_subdivision", $dparams);
	$xt->assign("mastertable_block", true);
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["subdivision_masterprint"] = $layout;
