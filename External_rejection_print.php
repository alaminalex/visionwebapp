...
$page_layouts["External_Rejection_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=External_Rejection.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=External_Rejection.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("DATE_qcend_date__fieldheader", true);
$xt->assign("qc_id_fieldheader", true);
$xt->assign("files_rejected_fieldheader", true);
$xt->assign("SEC_TO_TIME_sum_time_to_sec_qc_time____fieldheader", true);
