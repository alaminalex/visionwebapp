...
require_once("include/Daily_Files_Done_by_Designers__PDF__variables.php");
...
$layout = new TLayout("report21", "Coral1vApplication", "MobilevApplication");
$layout->version = 2;
...
$layout->containers["pagination_1"] = array();
$layout->container_properties["pagination_1"] = array(  );
$layout->containers["pagination_1"][] = array("name"=>"pagination", 
	"block"=>"pagination_block", "substyle"=>1  );

$layout->skins["pagination_1"] = "2";

$layout->blocks["center"][] = "pagination_1";
$layout->blocks["left"] = array();
$layout->containers["left_4"] = array();
$layout->container_properties["left_4"] = array(  );
$layout->containers["left_4"][] = array("name"=>"searchpanel", 
	"block"=>"searchPanel", "substyle"=>1  );

$layout->skins["left_4"] = "menu";

$layout->blocks["left"][] = "left_4";
...
$layout->containers["left"][] = array("name"=>"hmenu", 
	"block"=>"menu_block", "substyle"=>1  );

$layout->skins["left"] = "menu";

$layout->blocks["top"][] = "left";
$layout->containers["left_1"] = array();
$layout->container_properties["left_1"] = array(  );
$layout->containers["left_1"][] = array("name"=>"hmenu", 
	"block"=>"menu_block", "substyle"=>1  );

$layout->skins["left_1"] = "menu";

$layout->blocks["top"][] = "left_1";
$layout->containers["left_2"] = array();
$layout->container_properties["left_2"] = array(  );
$layout->containers["left_2"][] = array("name"=>"hmenu", 
	"block"=>"menu_block", "substyle"=>1  );

$layout->skins["left_2"] = "menu";

$layout->blocks["top"][] = "left_2";
$layout->containers["left_3"] = array();
$layout->container_properties["left_3"] = array(  );
$layout->containers["left_3"][] = array("name"=>"hmenu", 
	"block"=>"menu_block", "substyle"=>1  );

$layout->containers["left_3"][] = array("name"=>"hmenu", 
	"block"=>"menu_block", "substyle"=>1  );

$layout->skins["left_3"] = "menu";

$layout->blocks["top"][] = "left_3";
...
$page_layouts["Daily_Files_Done_by_Designers__PDF__report"] = $layout;
