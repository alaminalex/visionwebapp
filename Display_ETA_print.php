...
require_once("include/Display_ETA_variables.php");
...
$page_layouts["Display_ETA_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Display_ETA.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Display_ETA.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("text_fieldheader", true);
$xt->assign("Files_fieldheader", true);
$xt->assign("need_eta_fieldheader", true);
