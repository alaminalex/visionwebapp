...
require_once("include/Emailer_variables.php");
...
$layout = new TLayout("dashboard", "Coral1vApplication", "MobilevApplication");
$layout->version = 2;
...
$page_layouts["Emailer_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Emailer", "dashboard");
