...
require_once("include/Display_Files_Need_to_Work_QC_variables.php");
...
$page_layouts["Display_Files_Need_to_Work_QC_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Display_Files_Need_to_Work_QC.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Display_Files_Need_to_Work_QC.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
