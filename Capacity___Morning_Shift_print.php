...
$page_layouts["Capacity___Morning_Shift_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Capacity___Morning_Shift.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Capacity___Morning_Shift.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("distribute_date_fieldheader", true);
$xt->assign("files_remaining_to_deliver_fieldheader", true);
$xt->assign("total_estimated_fieldheader", true);
$xt->assign("remaining_this_shift_fieldheader", true);
$xt->assign("remaining_capacity_fieldheader", true);
