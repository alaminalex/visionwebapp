...
$page_layouts["Monthly_Report_Designer_PDF_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Monthly_Report_Designer_PDF.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Monthly_Report_Designer_PDF.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("end2_date_fieldheader", true);
...
$xt->assign("taken_time_total_fieldheader", true);
$xt->assign("taken_time_avg_fieldheader", true);
$xt->assign("efficiency_avg_CAL_1_fieldheader", true);
