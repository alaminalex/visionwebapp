...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=XX.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("avg_eta_fieldheader", true);
$xt->assign("Total_time_fieldheader", true);
$xt->assign("avg_time_fieldheader", true);
$xt->assign("efficiency_avg_fieldheader", true);
