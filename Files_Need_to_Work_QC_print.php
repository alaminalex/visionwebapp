...
require_once("include/Files_Need_to_Work_QC_variables.php");
...
$page_layouts["Files_Need_to_Work_QC_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Files_Need_to_Work_QC.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Files_Need_to_Work_QC.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
