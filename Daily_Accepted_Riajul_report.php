...
require_once("include/Daily_Accepted_Riajul_variables.php");
...
$layout->containers["left_2"][] = array("name"=>"searchpanel", 
	"block"=>"searchPanel", "substyle"=>1  );

$layout->skins["left_2"] = "menu";

$layout->blocks["left"][] = "left_2";
...
$page_layouts["Daily_Accepted_Riajul_report"] = $layout;
...
$page_layouts["clients_masterlist"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["user_masterlist"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["notifyoption_masterlist"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["pdf_masterlist"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["jobstatus_masterlist"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["project_masterlist"] = $layout;
