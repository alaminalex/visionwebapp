...
require_once("include/files_menu_count_variables.php");
...
$page_layouts["files_menu_count_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=files_menu_count.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=files_menu_count.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("Need_to__Designer_Work_All_Files_fieldheader", true);
$xt->assign("Need_to_Work_All_Files_fieldheader", true);
$xt->assign("Need_to_QC_All_Files_fieldheader", true);
$xt->assign("Need_to__Designer_Work_14704_Files_fieldheader", true);
$xt->assign("Need_to_Work_14704_Files_fieldheader", true);
$xt->assign("Need_to_QC_14704_Files_fieldheader", true);
$xt->assign("Need_to__Designer_Work_18442_Files_fieldheader", true);
$xt->assign("Need_to_Work_18442_Files_fieldheader", true);
$xt->assign("Need_to_QC_18442_Files_fieldheader", true);
$xt->assign("Need_to_Designer_Work_Others_Files_fieldheader", true);
$xt->assign("Need_to_Work_Others_Files_fieldheader", true);
$xt->assign("Need_to_QC_Others_Files_fieldheader", true);
