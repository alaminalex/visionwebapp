...
$page_layouts["Rejection_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Rejection.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Rejection.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("job_id_fieldheader", true);
$xt->assign("previous_job_id_fieldheader", true);
$xt->assign("project_id_fieldheader", true);
$xt->assign("filename_fieldheader", true);
$xt->assign("jobfile_type_fieldheader", true);
$xt->assign("jobfile_note_fieldheader", true);
$xt->assign("jobfile_status_id_fieldheader", true);
$xt->assign("qc_id_fieldheader", true);
$xt->assign("rejector_id_fieldheader", true);
$xt->assign("qc_time_fieldheader", true);
$xt->assign("reject_date_fieldheader", true);
$xt->assign("reject_reason_fieldheader", true);
$xt->assign("reject_reason_others_fieldheader", true);
$xt->assign("screenshots_fieldheader", true);
$xt->assign("designer2_id_fieldheader", true);
$xt->assign("designer2_time_fieldheader", true);
