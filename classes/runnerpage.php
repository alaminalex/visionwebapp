...
class RunnerPage
{
	...
	function &getMenuNodes($name = 'main')
	{
		if(!count($this->menuNodes[$name]))
		{
			...
			if($name == '14704_menu')
			{
				getMenuNodes_14704_menu($menuNodesObject);
				return $this->menuNodes[$name];
			}
			if($name == '18442')
			{
				getMenuNodes_18442($menuNodesObject);
				return $this->menuNodes[$name];
			}
			if($name == 'a_report_menu')
			{
				getMenuNodes_a_report_menu($menuNodesObject);
				return $this->menuNodes[$name];
			}
			if($name == 'admin_menu')
			{
				getMenuNodes_admin_menu($menuNodesObject);
				return $this->menuNodes[$name];
			}
	...
	function addCommonJs() 
	{
		if ($this->debugJSMode === true)
		{
			...
			$this->AddJSFile("include/runnerJS/pages/RightsPage.js", "include/runnerJS/pages/CheckboxesPage.js");
				...
				//Activ Directory
			$this->AddJSFile("include/runnerJS/pages/RightsPageAD.js", "include/runnerJS/pages/RightsPage.js");
			$this->AddJSFile("include/runnerJS/pages/MembersPageAD.js", "include/runnerJS/pages/CheckboxesPage.js");
