...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		if("department" == $this->xml_array['tables'][0])
			$isDB = true;
		if("group" == $this->xml_array['tables'][0])
			$isDB = true;
		if("job" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobstatus" == $this->xml_array['tables'][0])
			$isDB = true;
		if("notifyoption" == $this->xml_array['tables'][0])
			$isDB = true;
		if("subdivision" == $this->xml_array['tables'][0])
			$isDB = true;
		...
		if("job" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pdf" == $this->xml_array['tables'][0])
			$isDB = true;
		if("project" == $this->xml_array['tables'][0])
			$isDB = true;
		if("job" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("team" == $this->xml_array['tables'][0])
			$isDB = true;
		if("job" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile" == $this->xml_array['tables'][0])
		...
		if("user" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ad_uggroups" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ad_ugmembers" == $this->xml_array['tables'][0])
			$isDB = true;
		if("job" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("data_audit" == $this->xml_array['tables'][0])
			$isDB = true;
		if("job" == $this->xml_array['tables'][0])
			$isDB = true;
		if("job" == $this->xml_array['tables'][0])
		...
		if("jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("designer_report" == $this->xml_array['tables'][0])
			$isDB = true;
		if("designer_report" == $this->xml_array['tables'][0])
			$isDB = true;
		if("custompages" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("rejected_jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("type_of_errors" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("user" == $this->xml_array['tables'][0])
		...
		if("status" == $this->xml_array['tables'][0])
			$isDB = true;
		if("designation" == $this->xml_array['tables'][0])
			$isDB = true;
		if("rejected_jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pdf" == $this->xml_array['tables'][0])
		...
		if("jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("clients" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ad_ugrights" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ad_uggroups" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile" == $this->xml_array['tables'][0])
		...
		if("designer_report" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pdf_report" == $this->xml_array['tables'][0])
			$isDB = true;
		if("rejected_jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile" == $this->xml_array['tables'][0])
		...
		if("jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("mail_messages" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile" == $this->xml_array['tables'][0])
		...
		if("job" == $this->xml_array['tables'][0])
			$isDB = true;
		if("attendance_sheet" == $this->xml_array['tables'][0])
			$isDB = true;
		if("data_audit" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ShiftType" == $this->xml_array['tables'][0])
			$isDB = true;
		if("UserShift" == $this->xml_array['tables'][0])
			$isDB = true;
		if("user" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("work_type" == $this->xml_array['tables'][0])
			$isDB = true;
		if("rejected_job" == $this->xml_array['tables'][0])
			$isDB = true;
		if("job" == $this->xml_array['tables'][0])
			$isDB = true;
		if("rejected_jobfile2" == $this->xml_array['tables'][0])
			$isDB = true;
		if("rejected_jobfile2" == $this->xml_array['tables'][0])
			$isDB = true;
		if("rejected_job" == $this->xml_array['tables'][0])
		...
		if("rejected_jobfile2" == $this->xml_array['tables'][0])
			$isDB = true;
		if("users_work_report" == $this->xml_array['tables'][0])
			$isDB = true;
		if("rejected_jobfile2" == $this->xml_array['tables'][0])
			$isDB = true;
		if("jobfile_type" == $this->xml_array['tables'][0])
			$isDB = true;
		if("users_work_report" == $this->xml_array['tables'][0])
			$isDB = true;
		if("users_work_report" == $this->xml_array['tables'][0])
