...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("group" == $this->chrt_array['tables'][0])
			return true;
		if("job" == $this->chrt_array['tables'][0])
			return true;
		if("jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("jobstatus" == $this->chrt_array['tables'][0])
			return true;
		if("notifyoption" == $this->chrt_array['tables'][0])
			return true;
		if("subdivision" == $this->chrt_array['tables'][0])
			return true;
		...
		if("job" == $this->chrt_array['tables'][0])
			return true;
		if("pdf" == $this->chrt_array['tables'][0])
			return true;
		...
		if("jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("team" == $this->chrt_array['tables'][0])
			return true;
		if("job" == $this->chrt_array['tables'][0])
			return true;
		if("jobfile" == $this->chrt_array['tables'][0])
		...
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("ad_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("ad_ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("job" == $this->chrt_array['tables'][0])
			return true;
		if("jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("data_audit" == $this->chrt_array['tables'][0])
			return true;
		if("job" == $this->chrt_array['tables'][0])
			return true;
		if("job" == $this->chrt_array['tables'][0])
		...
		if("jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("designer_report" == $this->chrt_array['tables'][0])
			return true;
		if("designer_report" == $this->chrt_array['tables'][0])
			return true;
		if("custompages" == $this->chrt_array['tables'][0])
			return true;
		if("jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("rejected_jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("type_of_errors" == $this->chrt_array['tables'][0])
			return true;
		if("jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("user" == $this->chrt_array['tables'][0])
		...
		if("status" == $this->chrt_array['tables'][0])
			return true;
		if("designation" == $this->chrt_array['tables'][0])
			return true;
		if("rejected_jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("pdf" == $this->chrt_array['tables'][0])
		...
		if("jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("clients" == $this->chrt_array['tables'][0])
			return true;
		if("ad_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("ad_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("jobfile" == $this->chrt_array['tables'][0])
		...
		if("designer_report" == $this->chrt_array['tables'][0])
			return true;
		if("pdf_report" == $this->chrt_array['tables'][0])
			return true;
		if("rejected_jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("jobfile" == $this->chrt_array['tables'][0])
		...
		if("job" == $this->chrt_array['tables'][0])
			return true;
		if("attendance_sheet" == $this->chrt_array['tables'][0])
			return true;
		if("data_audit" == $this->chrt_array['tables'][0])
			return true;
		if("ShiftType" == $this->chrt_array['tables'][0])
			return true;
		if("UserShift" == $this->chrt_array['tables'][0])
			return true;
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("jobfile" == $this->chrt_array['tables'][0])
			return true;
		if("work_type" == $this->chrt_array['tables'][0])
			return true;
		if("rejected_job" == $this->chrt_array['tables'][0])
			return true;
		if("job" == $this->chrt_array['tables'][0])
			return true;
		if("rejected_jobfile2" == $this->chrt_array['tables'][0])
			return true;
		if("rejected_jobfile2" == $this->chrt_array['tables'][0])
			return true;
		if("rejected_job" == $this->chrt_array['tables'][0])
		...
		if("rejected_jobfile2" == $this->chrt_array['tables'][0])
			return true;
		if("users_work_report" == $this->chrt_array['tables'][0])
			return true;
		if("rejected_jobfile2" == $this->chrt_array['tables'][0])
			return true;
		if("jobfile_type" == $this->chrt_array['tables'][0])
			return true;
		if("users_work_report" == $this->chrt_array['tables'][0])
			return true;
		if("users_work_report" == $this->chrt_array['tables'][0])
