...
$page_layouts["Pending_Jobs_detailspreview"] = $layout;
...
if($mastertable == "Designer Filesheet")
{
	$where = "";
		$formattedValue = make_db_value("work_id",$_SESSION[$sessionPrefix."_masterkey1"]);
	if( $formattedValue == "null" )
		$where .= $pageObject->getFieldSQLDecrypt("work_id") . "is null";
	else
		$where .= $pageObject->getFieldSQLDecrypt("work_id") . "=" . $formattedValue;
}
...
$xt->load_template(GetTemplateName("Pending_Jobs", "detailspreview"));
