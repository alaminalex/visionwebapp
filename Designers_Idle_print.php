...
$page_layouts["Designers_Idle_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Designers_Idle.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Designers_Idle.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("taken_time_total_reject_qc_fieldheader", true);
$xt->assign("taken_time_avg_fieldheader", true);
$xt->assign("efficiency_fieldheader", true);
$xt->assign("idle_time_fieldheader", true);
$xt->assign("idle_percentage_fieldheader", true);
$xt->assign("rejected_fieldheader", true);
