...
require_once("include/Daily_Designers_New_variables.php");
...
$page_layouts["Daily_Designers_New_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_Designers_New.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Daily_Designers_New.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("work_date_fieldheader", true);
$xt->assign("user_name_fieldheader", true);
$xt->assign("team_id_fieldheader", true);
$xt->assign("subdiv_id_fieldheader", true);
$xt->assign("user_group_fieldheader", true);
$xt->assign("pdf_name_fieldheader", true);
$xt->assign("designer_done_fieldheader", true);
$xt->assign("designer_eta_fieldheader", true);
$xt->assign("designer_time_fieldheader", true);
$xt->assign("QC_done_fieldheader", true);
$xt->assign("qc_eta_fieldheader", true);
$xt->assign("qc_time_fieldheader", true);
$xt->assign("rejected_by_qc_fieldheader", true);
$xt->assign("rejected_designer_ETA_fieldheader", true);
$xt->assign("rejected_designer_time_fieldheader", true);
$xt->assign("rejected_customer_fieldheader", true);
$xt->assign("rejected_customer_eta_fieldheader", true);
$xt->assign("rejected_customer_time_fieldheader", true);
$xt->assign("efficiency_fieldheader", true);
$xt->assign("work_type_fieldheader", true);
$xt->assign("comments_fieldheader", true);
