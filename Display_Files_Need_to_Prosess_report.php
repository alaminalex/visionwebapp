...
require_once("include/Display_Files_Need_to_Prosess_variables.php");
...
$layout = new TLayout("report21", "DisplayDisplay", "MobileDisplay");
$layout->version = 2;
...
$page_layouts["Display_Files_Need_to_Prosess_report"] = $layout;
