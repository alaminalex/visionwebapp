...
require_once("include/18442_Deadline_Missed_variables.php");
...
$layout = new TLayout("edit_under_2col_center", "Coral1vApplication", "MobilevApplication");
$layout->version = 2;
...
$layout->containers["fields"][] = array("name"=>"editfields2_atop", 
	"block"=>"", "substyle"=>1  );
...
$page_layouts["18442_Deadline_Missed_edit"] = $layout;
...
$layout = new TLayout("tab", "Coral1vApplication", "MobilevApplication");
$layout->version = 2;
...
$page_layouts["18442_Deadline_Missed_edit_Aditional_Complexcity1"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["18442_Deadline_Missed_edit_Information1"] = $layout;
...
$keys = array();
$keys["work_id"] = postvalue("editid1");
