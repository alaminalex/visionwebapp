...
require_once("include/Client_Instruction_variables.php");
...
$page_layouts["Client_Instruction_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= $pageObject->getFieldSQLDecrypt("client_id") . "=" . make_db_value("client_id",$_SESSION[$strTableName."_masterkey1"]);
}
...
$xt->load_template(GetTemplateName("Client_Instruction", "detailspreview"));
