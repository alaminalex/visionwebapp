...
require_once("include/jobstatus_variables.php");
...
$page_layouts["jobstatus_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["Download_Job_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["Pending_Jobs_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["Download_Reject_Job_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "jobstatus" );
