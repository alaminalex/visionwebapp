...
$page_layouts["14704_Monthly_Designers_Avrage_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=14704_Monthly_Designers_Avrage.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=14704_Monthly_Designers_Avrage.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("eta_average_fieldheader", true);
$xt->assign("current_avg_fieldheader", true);
