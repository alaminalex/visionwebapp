<?php 
class eventclass_Designer_Level_2_for_Correction  extends eventsBase
{ 
	function eventclass_Designer_Level_2_for_Correction()
	{
	// fill list of events
...
$strWhereClause = "rejected_jobfile2.designer2_id = $current_user_id";
