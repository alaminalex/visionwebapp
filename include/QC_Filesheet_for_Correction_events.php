<?php 
class eventclass_QC_Filesheet_for_Correction  extends eventsBase
{ 
	function eventclass_QC_Filesheet_for_Correction()
	{
	// fill list of events
...
$strWhereClause = whereAdd($strWhereClause, "qc_id = '".$_SESSION["user_id"]."' AND `rejected_job`.`job_id`='".$GLOBALS["job_id"]."'");
}
else
{
