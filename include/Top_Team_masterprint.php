<?php
function DisplayMasterTableInfoForPrint_Top_Team($params)
{
	global $cman;
	...
	if( $detailtable == "job" )
	{
		...
		$showKeys.= " ".GetFieldLabel("Top_Team","user_id").": ".$keyValue;
	...
	$layout = GetPageLayout("Top_Team", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("Top_Team", "masterprint"));
}
