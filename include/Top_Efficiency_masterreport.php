<?php
function DisplayMasterTableInfo_Top_Efficiency($params)
{
	global $cman;
	...
	$layout = GetPageLayout("Top_Efficiency", "masterreport");
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("Top_Efficiency", "masterreport"));
}
?>