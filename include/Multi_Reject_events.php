<?php 
class eventclass_Multi_Reject  extends eventsBase
{ 
	function eventclass_Multi_Reject()
	{
	// fill list of events
...
//	onscreen events
		$this->events["File_Distribution_snippet23"] = true;
		$this->events["File_Distribution_snippet32"] = true;
		$this->events["File_Distribution_snippet5"] = true;
...
//	onscreen events
function File_Distribution_snippet23(&$params)
{
...
function File_Distribution_snippet32(&$params)
{
$file_list_get = $_GET["file_list"];
$file_list_get = explode(",", $file_list_get);
...
function File_Distribution_snippet5(&$params)
{
$file_list_get = $_GET["file_list"];
$file_list_get = explode(",", $file_list_get);
echo COUNT($file_list_get)." Files are selected";
