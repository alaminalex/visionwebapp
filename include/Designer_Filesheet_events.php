<?php 
class eventclass_Designer_Filesheet  extends eventsBase
{ 
	function eventclass_Designer_Filesheet()
	{
	// fill list of events
...
//	onscreen events
		$this->events["Designer_Filesheet_snippet"] = true;
...
if($_GET["q"] != "")
{
//$strWhereClause = "`designer_id`='".$_SESSION["user_id"]."' AND `job_id`='".$GLOBALS["job_id"]."'";
$strWhereClause = whereAdd($strWhereClause, "jobfile.designer_id = '".$_SESSION["user_id"]."' AND `jobfile`.`job_id`='".$GLOBALS["job_id"]."'");

}
else
{
//$strWhereClause = "`designer_id`='".$_SESSION["user_id"]."'";
$strWhereClause = whereAdd($strWhereClause, "jobfile.designer_id = '".$_SESSION["user_id"]."'");
...
//	onscreen events
function Designer_Filesheet_snippet(&$params)
{
/*
		$get_query_string = $_GET["q"];
$string = $get_query_string;
