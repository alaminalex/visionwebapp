					...
					if (isset($_POST["user_input_ok"]))
						{
							...
							$select_file_sql = "SELECT `file_url`, `work_id` from rejected_jobfile WHERE `file_url`='$safe_selected_file' AND `work_id`='$selected_work_id' ";
							...
							if ($is_duplicate > 0)
								...
								//PROCESS THE JOB INSERT THE INFORMATION INTO THE DATABASE
									...
									$insert_new_file_sql = "
									INSERT INTO `visionwebapp`.`rejected_jobfile` (
									...
									if(!$insert_file_result = mysqli_query($mysqlilink, $insert_new_file_sql))
										...
										echo "<h2>Errors Found. Cannot Continue Inserting data</h2>";
											...
											AND jobfile.filename = '".$selected_file."'";
