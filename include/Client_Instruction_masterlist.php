<?php
function DisplayMasterTableInfo_Client_Instruction($params)
{
	$keys = $params["keys"];
	...
	$layout = GetPageLayout("Client_Instruction", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("Client_Instruction", "masterlist"));
}
