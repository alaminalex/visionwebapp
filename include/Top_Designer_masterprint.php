<?php
function DisplayMasterTableInfoForPrint_Top_Designer($params)
{
	global $cman;
	...
	$layout = GetPageLayout("Top_Designer", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("Top_Designer", "masterprint"));
}
