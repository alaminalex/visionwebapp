<?php 
class eventclass_rejected_job  extends eventsBase
{ 
	function eventclass_rejected_job()
	{
	// fill list of events
...
if($data['jobstatus_id'] != "0" || $data['jobstatus_id'] != "1" || $data['jobstatus_id'] != "2" || $data['jobstatus_id'] != "9" || $data['jobstatus_id'] != "10" || $data['jobstatus_id'] != "11" || $data['jobstatus_id'] != "12" || $data['jobstatus_id'] != "0" )
{
