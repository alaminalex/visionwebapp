...
function checkTableName($shortTName, $type=false)
{
	...
	if ("job" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("jobfile" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("jobstatus" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("notifyoption" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("subdivision" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("user" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Dashboard" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("File_Distribution" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Download_Job" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Pending_Jobs" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("pdf" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("project" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Designer_Worksheet" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Designer_Filesheet" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("team" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("QC_Worksheet" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("QC_Filesheet" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("All_Jobs" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Daily_Job_Report__Accepted_" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Users" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("ad_uggroups" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ad_ugmembers" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Designer_Level_2" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Designer_Level2_Filesheet" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("data_audit" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Urgent_Jobs" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Deadline_Missed" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Need_to_Accept" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Need_Notify" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Need_Download" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Need_QC" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Need_Upload" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Pending_14704" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Daily_Job_Report__Notified_" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("14704_Need_QC" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("14704_Need_Upload" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("14704_Need_Download" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("14704_Need_Notify" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("14704_Need_Accept" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("14704_Deadline_Missed" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("14704_Urgent_Jobs" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("File_Reject" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("designer_report" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Designer_Report__All_" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("custompages" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("14704_Daily_Report_Full" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("rejected_jobfile" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("type_of_errors" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("14704_Designer_Report" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Team_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("status" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("designation" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Correction_Files" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Client_Instruction" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("14704_Monthly_Report_Full" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("14704_Daily_Report_Designers" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("14704_Monthly_Report_Designers" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("14704_Daily_Report__Team" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Delected_Jobs" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("14704_Monthly_Report_Team" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Daily_Report_Designers" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Monthly_Report_Designers" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Daily_Report_Team" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Monthly_Report_Team" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Daily_Report_Full" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Monthly_Report_Full" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Capacity___Night_Shift" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Capacity___Morning_Shift" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Capacity___Evening_Shift" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Pending_18442" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("18442_Deadline_Missed" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("18442_Urgent_Jobs" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("18442_Need_Notify" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("18442_Need_Upload" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("18442_Need_QC" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("18442_Need_Download" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("18442_Need_Accept" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Monthly_PDF_Avrage" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Daily_Report_Designer_PDF" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Monthly_Job_Report__Accepted_" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Monthly_Report_Designer_PDF" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Monthly_Job_Report__Notified_" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("14704_Week_Report_Team" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("14704_Monthly_Designers_Avrage" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("clients" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("admin_rights" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("admin_admembers" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Designer_files_report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("PDF_Done___Evening_Shift" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("PDF_Done___Morning_Shift" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("PDF_Done___Night_Shift" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("PDF_Done___Today" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Files_Need_to_Work" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Weekly_Report_Designers" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Designers_Work_Profile" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Designers_Performance" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Designers_Performance_Monthly" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("Daily_QC" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_Files_Now_Working" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_Files_Need_to_Work_QC" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_Files_Done_Today" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Daily_Report_33392" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("generator_rex" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_generator_top_images" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_top_team_performance" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_top_designer_performance" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Daily_PDF_Avrage" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Weekly_PDF_Avrage" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("pdf_report" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Display_Rejected_today" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_QC_Done_Today" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_Files_Notifyed_Today" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("mail_messages" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Emailer" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("Display_Files_Need_to_Download" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_Files_Need_to_Distribute" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_ETA" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_top_designer_Files" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_Files_Need_to_Prosess" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Daily_Accepted_Riajul" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("attendance_sheet" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("employee_present" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("ShiftType" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("UserShift" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("user1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Daily_Designers_and_QC" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("work_type" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("rejected_job" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Download_Reject_Job" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("rejected_jobfile2" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("File_Distribution_Rejected" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Designer_Level_2_for_Correction" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Designer_Level2_Filesheet_for_Correction" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("QC_Worksheet_for_Correction" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("QC_Filesheet_for_Correction" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("External_Rejection" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("files_menu_count" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Display_Designer_Need" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Internal_Rejection" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Daily_Users_Work" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("not_for_use" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("jobfile_type" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("users_work_report" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Daily_Users_Work_Summery" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Daily_PDF_Work_Summery" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Backup_Notified_Jobs" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Daily_Users_Work_Summery_QC" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$strPerm = GetUserPermissions("jobfile");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="jobfile";
	}
	$strPerm = GetUserPermissions("jobstatus");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="jobstatus";
	}
	$strPerm = GetUserPermissions("notifyoption");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="notifyoption";
	}
	$strPerm = GetUserPermissions("subdivision");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="subdivision";
	}
	...
	$strPerm = GetUserPermissions("File Distribution");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="File Distribution";
	}
	$strPerm = GetUserPermissions("Download Job");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Download Job";
	}
	$strPerm = GetUserPermissions("Pending Jobs");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Pending Jobs";
	}
	$strPerm = GetUserPermissions("pdf");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="pdf";
	}
	...
	$strPerm = GetUserPermissions("Designer Worksheet");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designer Worksheet";
	}
	$strPerm = GetUserPermissions("Designer Filesheet");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designer Filesheet";
	}
	$strPerm = GetUserPermissions("team");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="team";
	}
	$strPerm = GetUserPermissions("QC Worksheet");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="QC Worksheet";
	}
	$strPerm = GetUserPermissions("QC Filesheet");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="QC Filesheet";
	}
	$strPerm = GetUserPermissions("All Jobs");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="All Jobs";
	}
	$strPerm = GetUserPermissions("Daily Job Report (Accepted)");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Job Report (Accepted)";
	}
	...
	$strPerm = GetUserPermissions("ad_uggroups");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ad_uggroups";
	}
	$strPerm = GetUserPermissions("ad_ugmembers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ad_ugmembers";
	}
	$strPerm = GetUserPermissions("Designer Level 2");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designer Level 2";
	}
	$strPerm = GetUserPermissions("Designer Level2 Filesheet");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designer Level2 Filesheet";
	}
	$strPerm = GetUserPermissions("data_audit");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="data_audit";
	}
	$strPerm = GetUserPermissions("Urgent Jobs");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Urgent Jobs";
	}
	$strPerm = GetUserPermissions("Deadline Missed");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Deadline Missed";
	}
	$strPerm = GetUserPermissions("Need to Accept");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Need to Accept";
	}
	$strPerm = GetUserPermissions("Need Notify");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Need Notify";
	}
	$strPerm = GetUserPermissions("Need Download");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Need Download";
	}
	$strPerm = GetUserPermissions("Need QC");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Need QC";
	}
	$strPerm = GetUserPermissions("Need Upload");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Need Upload";
	}
	$strPerm = GetUserPermissions("Pending 14704");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Pending 14704";
	}
	$strPerm = GetUserPermissions("Daily Job Report (Notified)");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Job Report (Notified)";
	}
	$strPerm = GetUserPermissions("14704 Need QC");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Need QC";
	}
	$strPerm = GetUserPermissions("14704 Need Upload");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Need Upload";
	}
	$strPerm = GetUserPermissions("14704 Need Download");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Need Download";
	}
	$strPerm = GetUserPermissions("14704 Need Notify");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Need Notify";
	}
	$strPerm = GetUserPermissions("14704 Need Accept");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Need Accept";
	}
	$strPerm = GetUserPermissions("14704 Deadline Missed");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Deadline Missed";
	}
	$strPerm = GetUserPermissions("14704 Urgent Jobs");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Urgent Jobs";
	}
	$strPerm = GetUserPermissions("File Reject");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="File Reject";
	}
	$strPerm = GetUserPermissions("designer_report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="designer_report";
	}
	$strPerm = GetUserPermissions("Designer Report (All)");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designer Report (All)";
	}
	$strPerm = GetUserPermissions("custompages");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="custompages";
	}
	$strPerm = GetUserPermissions("14704 Daily Report Full");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Daily Report Full";
	}
	$strPerm = GetUserPermissions("rejected_jobfile");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="rejected_jobfile";
	}
	$strPerm = GetUserPermissions("type_of_errors");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="type_of_errors";
	}
	$strPerm = GetUserPermissions("14704 Designer Report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Designer Report";
	}
	$strPerm = GetUserPermissions("Team Report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Team Report";
	}
	...
	$strPerm = GetUserPermissions("designation");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="designation";
	}
	$strPerm = GetUserPermissions("Correction Files");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Correction Files";
	}
	$strPerm = GetUserPermissions("Client Instruction");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Client Instruction";
	}
	$strPerm = GetUserPermissions("14704 Monthly Report Full");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Monthly Report Full";
	}
	$strPerm = GetUserPermissions("14704 Daily Report Designers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Daily Report Designers";
	}
	$strPerm = GetUserPermissions("14704 Monthly Report Designers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Monthly Report Designers";
	}
	$strPerm = GetUserPermissions("14704 Daily Report  Team");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Daily Report  Team";
	}
	$strPerm = GetUserPermissions("Delected Jobs");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Delected Jobs";
	}
	$strPerm = GetUserPermissions("14704 Monthly Report Team");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Monthly Report Team";
	}
	$strPerm = GetUserPermissions("Daily Report Designers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Report Designers";
	}
	$strPerm = GetUserPermissions("Monthly Report Designers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Monthly Report Designers";
	}
	$strPerm = GetUserPermissions("Daily Report Team");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Report Team";
	}
	$strPerm = GetUserPermissions("Monthly Report Team");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Monthly Report Team";
	}
	$strPerm = GetUserPermissions("Daily Report Full");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Report Full";
	}
	$strPerm = GetUserPermissions("Monthly Report Full");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Monthly Report Full";
	}
	$strPerm = GetUserPermissions("Capacity - Night Shift");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Capacity - Night Shift";
	}
	$strPerm = GetUserPermissions("Capacity - Morning Shift");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Capacity - Morning Shift";
	}
	$strPerm = GetUserPermissions("Capacity - Evening Shift");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Capacity - Evening Shift";
	}
	$strPerm = GetUserPermissions("Pending 18442");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Pending 18442";
	}
	$strPerm = GetUserPermissions("18442 Deadline Missed");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="18442 Deadline Missed";
	}
	$strPerm = GetUserPermissions("18442 Urgent Jobs");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="18442 Urgent Jobs";
	}
	$strPerm = GetUserPermissions("18442 Need Notify");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="18442 Need Notify";
	}
	$strPerm = GetUserPermissions("18442 Need Upload");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="18442 Need Upload";
	}
	$strPerm = GetUserPermissions("18442 Need QC");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="18442 Need QC";
	}
	$strPerm = GetUserPermissions("18442 Need Download");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="18442 Need Download";
	}
	$strPerm = GetUserPermissions("18442 Need Accept");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="18442 Need Accept";
	}
	$strPerm = GetUserPermissions("Monthly PDF Avrage");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Monthly PDF Avrage";
	}
	$strPerm = GetUserPermissions("Daily Report Designer PDF");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Report Designer PDF";
	}
	$strPerm = GetUserPermissions("Monthly Job Report (Accepted)");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Monthly Job Report (Accepted)";
	}
	$strPerm = GetUserPermissions("Monthly Report Designer PDF");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Monthly Report Designer PDF";
	}
	$strPerm = GetUserPermissions("Monthly Job Report (Notified)");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Monthly Job Report (Notified)";
	}
	$strPerm = GetUserPermissions("14704 Week Report Team");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Week Report Team";
	}
	$strPerm = GetUserPermissions("14704 Monthly Designers Avrage");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="14704 Monthly Designers Avrage";
	}
	$strPerm = GetUserPermissions("clients");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="clients";
	}
	...
	$strPerm = GetUserPermissions("Designer files report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designer files report";
	}
	$strPerm = GetUserPermissions("PDF Done - Evening Shift");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PDF Done - Evening Shift";
	}
	$strPerm = GetUserPermissions("PDF Done - Morning Shift");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PDF Done - Morning Shift";
	}
	$strPerm = GetUserPermissions("PDF Done - Night Shift");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PDF Done - Night Shift";
	}
	$strPerm = GetUserPermissions("PDF Done - Today");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PDF Done - Today";
	}
	$strPerm = GetUserPermissions("Files Need to Work");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Files Need to Work";
	}
	$strPerm = GetUserPermissions("Weekly Report Designers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Weekly Report Designers";
	}
	$strPerm = GetUserPermissions("Designers Work Profile");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designers Work Profile";
	}
	$strPerm = GetUserPermissions("Designers Performance");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designers Performance";
	}
	$strPerm = GetUserPermissions("Designers Performance Monthly");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designers Performance Monthly";
	}
	$strPerm = GetUserPermissions("Display");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display";
	}
	$strPerm = GetUserPermissions("Daily QC");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily QC";
	}
	$strPerm = GetUserPermissions("Display Files Now Working");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display Files Now Working";
	}
	$strPerm = GetUserPermissions("Display Files Need to Work QC");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display Files Need to Work QC";
	}
	$strPerm = GetUserPermissions("Display Files Done Today");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display Files Done Today";
	}
	$strPerm = GetUserPermissions("Daily Report 33392");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Report 33392";
	}
	$strPerm = GetUserPermissions("generator_rex");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="generator_rex";
	}
	$strPerm = GetUserPermissions("Display generator_top_images");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display generator_top_images";
	}
	$strPerm = GetUserPermissions("Display_top_team_performance");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display_top_team_performance";
	}
	$strPerm = GetUserPermissions("Display_top_designer_performance");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display_top_designer_performance";
	}
	$strPerm = GetUserPermissions("Daily PDF Avrage");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily PDF Avrage";
	}
	$strPerm = GetUserPermissions("Weekly PDF Avrage");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Weekly PDF Avrage";
	}
	$strPerm = GetUserPermissions("pdf_report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="pdf_report";
	}
	$strPerm = GetUserPermissions("Display Rejected today");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display Rejected today";
	}
	$strPerm = GetUserPermissions("Display QC Done Today");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display QC Done Today";
	}
	$strPerm = GetUserPermissions("Display Files Notifyed Today");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display Files Notifyed Today";
	}
	...
	$strPerm = GetUserPermissions("Emailer");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Emailer";
	}
	$strPerm = GetUserPermissions("Display Files Need to Download");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display Files Need to Download";
	}
	$strPerm = GetUserPermissions("Display Files Need to Distribute");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display Files Need to Distribute";
	}
	$strPerm = GetUserPermissions("Display ETA");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display ETA";
	}
	$strPerm = GetUserPermissions("Display_top_designer_Files");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display_top_designer_Files";
	}
	$strPerm = GetUserPermissions("Display Files Need to Prosess");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display Files Need to Prosess";
	}
	$strPerm = GetUserPermissions("Daily Accepted Riajul");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Accepted Riajul";
	}
	$strPerm = GetUserPermissions("attendance_sheet");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="attendance_sheet";
	}
	$strPerm = GetUserPermissions("employee_present");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="employee_present";
	}
	$strPerm = GetUserPermissions("ShiftType");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ShiftType";
	}
	$strPerm = GetUserPermissions("UserShift");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="UserShift";
	}
	$strPerm = GetUserPermissions("user1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="user1";
	}
	$strPerm = GetUserPermissions("Daily Designers and QC");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Designers and QC";
	}
	$strPerm = GetUserPermissions("work_type");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="work_type";
	}
	$strPerm = GetUserPermissions("rejected_job");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="rejected_job";
	}
	$strPerm = GetUserPermissions("Download Reject Job");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Download Reject Job";
	}
	$strPerm = GetUserPermissions("rejected_jobfile2");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="rejected_jobfile2";
	}
	$strPerm = GetUserPermissions("File Distribution Rejected");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="File Distribution Rejected";
	}
	$strPerm = GetUserPermissions("Designer Level 2 for Correction");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designer Level 2 for Correction";
	}
	$strPerm = GetUserPermissions("Designer Level2 Filesheet for Correction");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Designer Level2 Filesheet for Correction";
	}
	$strPerm = GetUserPermissions("QC Worksheet for Correction");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="QC Worksheet for Correction";
	}
	$strPerm = GetUserPermissions("QC Filesheet for Correction");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="QC Filesheet for Correction";
	}
	$strPerm = GetUserPermissions("External Rejection");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="External Rejection";
	}
	$strPerm = GetUserPermissions("files_menu_count");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="files_menu_count";
	}
	$strPerm = GetUserPermissions("Display_Designer_Need");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Display_Designer_Need";
	}
	$strPerm = GetUserPermissions("Internal Rejection");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Internal Rejection";
	}
	$strPerm = GetUserPermissions("Daily Users Work");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Users Work";
	}
	$strPerm = GetUserPermissions("not for use");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="not for use";
	}
	$strPerm = GetUserPermissions("jobfile_type");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="jobfile_type";
	}
	$strPerm = GetUserPermissions("users_work_report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="users_work_report";
	}
	$strPerm = GetUserPermissions("Daily Users Work Summery");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Users Work Summery";
	}
	$strPerm = GetUserPermissions("Daily PDF Work Summery");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily PDF Work Summery";
	}
	$strPerm = GetUserPermissions("Backup Notified Jobs");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Backup Notified Jobs";
	}
	$strPerm = GetUserPermissions("Daily Users Work Summery QC");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Daily Users Work Summery QC";
	}
	return $arr;
}
...
function ReadUserPermissions($userID = "")
{
	...
	if($userID != "Guest")
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "GroupID" ) 
			." from ". $grConnection->addTableWrappers( "ad_uggroups" )
	...
	$sql = "select ". $rConnection->addFieldWrappers( "TableName" )
		...
		." from ". $rConnection->addTableWrappers( "ad_ugrights" )
...
{	
	...
	if(array_key_exists("job",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("jobfile",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("jobstatus",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("notifyoption",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("subdivision",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("user",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Dashboard",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("File Distribution",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Download Job",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Pending Jobs",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("pdf",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("project",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designer Worksheet",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designer Filesheet",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("team",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("QC Worksheet",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("QC Filesheet",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("All Jobs",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Job Report (Accepted)",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Users",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("ad_uggroups",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("ad_ugmembers",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designer Level 2",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designer Level2 Filesheet",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("data_audit",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Urgent Jobs",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Deadline Missed",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Need to Accept",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Need Notify",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Need Download",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Need QC",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Need Upload",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Pending 14704",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Job Report (Notified)",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Need QC",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Need Upload",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Need Download",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Need Notify",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Need Accept",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Deadline Missed",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Urgent Jobs",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("File Reject",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("designer_report",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designer Report (All)",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("custompages",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Daily Report Full",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("rejected_jobfile",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("type_of_errors",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Designer Report",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Team Report",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("status",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("designation",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Correction Files",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Client Instruction",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Monthly Report Full",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Daily Report Designers",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Monthly Report Designers",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Daily Report  Team",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Delected Jobs",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Monthly Report Team",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Report Designers",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Monthly Report Designers",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Report Team",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Monthly Report Team",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Report Full",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Monthly Report Full",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Capacity - Night Shift",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Capacity - Morning Shift",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Capacity - Evening Shift",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Pending 18442",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("18442 Deadline Missed",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("18442 Urgent Jobs",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("18442 Need Notify",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("18442 Need Upload",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("18442 Need QC",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("18442 Need Download",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("18442 Need Accept",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Monthly PDF Avrage",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Report Designer PDF",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Monthly Job Report (Accepted)",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Monthly Report Designer PDF",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Monthly Job Report (Notified)",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Week Report Team",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("14704 Monthly Designers Avrage",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("clients",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("admin_rights",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("admin_admembers",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designer files report",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("PDF Done - Evening Shift",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("PDF Done - Morning Shift",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("PDF Done - Night Shift",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("PDF Done - Today",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Files Need to Work",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Weekly Report Designers",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designers Work Profile",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designers Performance",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designers Performance Monthly",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily QC",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display Files Now Working",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display Files Need to Work QC",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display Files Done Today",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Report 33392",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("generator_rex",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display generator_top_images",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display_top_team_performance",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display_top_designer_performance",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily PDF Avrage",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Weekly PDF Avrage",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("pdf_report",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display Rejected today",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display QC Done Today",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display Files Notifyed Today",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("mail_messages",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Emailer",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display Files Need to Download",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display Files Need to Distribute",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display ETA",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display_top_designer_Files",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display Files Need to Prosess",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Accepted Riajul",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("attendance_sheet",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("employee_present",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("ShiftType",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("UserShift",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("user1",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Designers and QC",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("work_type",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("rejected_job",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Download Reject Job",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("rejected_jobfile2",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("File Distribution Rejected",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designer Level 2 for Correction",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Designer Level2 Filesheet for Correction",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("QC Worksheet for Correction",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("QC Filesheet for Correction",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("External Rejection",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("files_menu_count",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Display_Designer_Need",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Internal Rejection",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Users Work",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("not for use",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("jobfile_type",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("users_work_report",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Users Work Summery",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily PDF Work Summery",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Backup Notified Jobs",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Daily Users Work Summery QC",$_SESSION["UserRights"]["Guest"]))
		return true;
	return false;
}
