...
function DisplayMasterTableInfoForPrint_Client_Instruction($params)
{
	global $cman;
	...
	if( $detailtable == "job" )
	{
		...
		$showKeys.= " ".GetFieldLabel("Client_Instruction","pdf_id").": ".$keyValue;
	...
	$layout = GetPageLayout("Client_Instruction", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("Client_Instruction", "masterprint"));
}
