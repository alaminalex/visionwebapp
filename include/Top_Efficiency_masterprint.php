<?php
function DisplayMasterTableInfoForPrint_Top_Efficiency($params)
{
	global $cman;
	...
	if( $detailtable == "job" )
	{
		...
		$showKeys.= " ".GetFieldLabel("Top_Efficiency","user_id").": ".$keyValue;
	...
	$layout = GetPageLayout("Top_Efficiency", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("Top_Efficiency", "masterprint"));
}
