...
$page_layouts["PDF_Done___Morning_Shift_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PDF_Done___Morning_Shift.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PDF_Done___Morning_Shift.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("totals_fieldheader", true);
$xt->assign("Taken_time_fieldheader", true);
$xt->assign("designers_used_fieldheader", true);
