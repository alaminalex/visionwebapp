...
require_once("include/Designers_Work_Profile_variables.php");
...
$page_layouts["Designers_Work_Profile_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Designers_Work_Profile.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Designers_Work_Profile.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("designer_name_fieldheader", true);
...
$xt->assign("total_eta_fieldheader", true);
$xt->assign("performance_fieldheader", true);
