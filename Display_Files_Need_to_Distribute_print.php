...
require_once("include/Display_Files_Need_to_Distribute_variables.php");
...
$page_layouts["Display_Files_Need_to_Distribute_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Display_Files_Need_to_Distribute.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Display_Files_Need_to_Distribute.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
